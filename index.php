...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img2/b2.jpg" alt="Los Angeles" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="img2/b3.jpg" alt="Chicago" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="img2/b4.jpg" alt="New York" width="1100" height="500">
    </div>
  </div>
...
<section class="my-5">
	...
	<div class="row">
		<div class="col-lg-6 col-md-6 col-12">
			<img src="img2/beach.jpg"class="img-fluid aboutimg">
			
		</div>
		<div class="col-lg-6 col-md-6 col-12">
			<h2 class="display-4">All are Good</h2>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-4 col-md-4 col-12">
			 <div class="card" >
	 <img class="card-img-top" src="img2/b2.jpg" alt="Card image">
	          <div class="card-body">
...
<section class="my-5">
	...
	<div class="py-5">
		<h2 class="text-center">Our Gallery
	</div>

	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-4 col-lg-4 col-12">
				<img src="img2/beach.jpg"class="img-fluid pb-4">
			</div>
				<div class="col-lg-4 col-lg-4 col-12">
				<img src="img2/beach.jpg"class="img-fluid pb-4">
			</div>
